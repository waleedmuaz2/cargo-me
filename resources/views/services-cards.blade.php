...
<!-- Mirrored from renthire.agthemes.net/services-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 23:10:32 GMT -->
<head>
		...
		<title>Services - cards / RentHire HTML template</title>
					...
					<section class="section">
						...
						<div class="row small-up-1 medium-up-2 large-up-3 dots-dark" data-equalizer data-equalize-on="large" data-carousel="medium-down">
							<div class="column column-block">
								...
								<article class="card card-post-icon block-shadow card-service">
									<div class="card-media">
										<img class="grayscale" src="img/services/services-01.jpg" alt="">
									</div>
							...
							<div class="column column-block">
								...
								<article class="card card-post-icon block-shadow card-service">
									<div class="card-media">
										<img class="grayscale" src="img/services/services-02.jpg" alt="">
									</div>
									<header class="card-divider bg-secondary">
							...
							<div class="column column-block">
								...
								<article class="card card-post-icon block-shadow card-service">
									<div class="card-media">
										<img class="grayscale" src="img/services/services-03.jpg" alt="">
									</div>
									<header class="card-divider bg-secondary">
							...
							<div class="column column-block">
								...
								<article class="card card-post-icon block-shadow card-service">
									<div class="card-media">
										<img class="grayscale" src="img/services/services-04.jpg" alt="">
									</div>
									<header class="card-divider bg-secondary">
							...
							<div class="column column-block">
								...
								<article class="card card-post-icon block-shadow card-service">
									<div class="card-media">
										<img class="grayscale" src="img/services/services-05.jpg" alt="">
									</div>
									<header class="card-divider bg-secondary">
							...
							<div class="column column-block">
								...
								<article class="card card-post-icon block-shadow card-service">
									<div class="card-media">
										<img class="grayscale" src="img/services/services-06.jpg" alt="">
									</div>
									<header class="card-divider bg-secondary">
						...
						<div class="column small-12">
							<div class="owl-carousel" data-owl-carousel data-button-type="rh-buttons" data-button-color="secondary secondary-gray" data-owl-options='{"smartSpeed": "500","dotsClass": "rh-owl-dots dots-dark", "responsive": {"640": {"items": "2", "slideBy": "2", "dots": false, "nav": "true"}, "1024": {"items": "3", "slideBy": "3", "dots": false, "nav": "true"}}}'>
								...
								<div class="card card-product bg-secondary block-shadow">
									...
									<img src="img/fleet/card-product-14.jpg" alt="">
								...
								<div class="card card-product block-shadow">
									...
									<img src="img/fleet/card-product-22.jpg" alt="">
								...
								<div class="card card-product bg-secondary block-shadow">
									...
									<img src="img/fleet/card-product-03.jpg" alt="">
								...
								<!-- Card product -->
								<div class="card card-product block-shadow">
									<img class="bg-secondary" src="img/fleet/card-product-t-01.png" alt="">
								...
								<!-- Card product -->
								<div class="card card-product bg-secondary block-shadow">
									<img class="bg-white" src="img/fleet/card-product-t-09.png" alt="">
								...
								<!-- Card product -->
								<div class="card card-product block-shadow">
									<img class="bg-secondary" src="img/fleet/card-product-t-11.png" alt="">
