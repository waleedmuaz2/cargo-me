...
<!-- Mirrored from renthire.agthemes.net/contact-us-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 23:14:44 GMT -->
<head>
		...
		<title>Contact us #3 / RentHire HTML template</title>
						...
						<div class="column small-12">
							<nav class="text-center" aria-label="You are here:">
								<ul class="breadcrumbs mb0">
									...
									<li><span class="show-for-sr">Current:</span>contact us #3</li>
								</ul>
							</nav>
						</div>
					</div>
						...
						<div class="row expanded small-up-1 medium-up-1 large-up-3 features">
							...
							<div class="column s-content-box">
								...
								<div class="media-object align-center mb0">
									...
									<div class="media-object-section">
										<h3 class="h4 headline">Opening times:</h3>
										<p>8.00 - 20.00</p>
									</div>
							...
							<div class="column s-content-box">
								<div class="s-content-box-image">
									<div class="grayscale" data-interchange="[img/sections/s-link-05.jpg, small]"></div>
								</div>
								...
								<div class="media-object align-center mb0">
									...
									<div class="media-object-section">
										<h3 class="h4 headline">Give us a call:</h3>
										<ul class="no-bullet">
											<li>
												<a class="phone block-link" href="tel:YourPhoneNumber">347-222-7564</a>
											</li>
											<li>
												<a class="phone block-link" href="tel:YourPhoneNumber">347-222-6475</a>
											</li>
										</ul>
									</div>
								</div><!-- /end .media-object -->
							...
							<div class="column s-content-box">
								<div class="s-content-box-image">
									<div class="grayscale" data-interchange="[img/sections/s-link-06.jpg, small]"></div>
								</div>
								...
								<div class="media-object align-center mb0">
									...
									<div class="media-object-section">
										<h3 class="h4 headline">Contact online</h3>
										<ul class="no-bullet">
											<li>
												<a class="mail block-link" href="mailto:sales@domain.com">sales@domain.com</a>
											</li>
											<li>
												<a class="mail block-link" href="mailto:orders@domain.com">orders@domain.com</a>
											</li>
										</ul>
									</div>
								</div><!-- /end .media-object -->
